...
<div class="container">
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">Изменить страницу</div>
            <div class="panel-body">
                <form role="form" action=<?= "update_post.php?id=". $id; ?> method="post" enctype = 'multipart/form-data'>
                    <div class="form-group">
                        <label class="control-label"></label>
                        <input type="text" class="form-control" name="postTitle" value=<?= $title; ?>>
                    </div>

                    <div class="form-group">
                        <label for="Description">Описание : </label>
                        <textarea class="form-control" rows="8" id="content" name="postDesc"><?= $desc; ?></textarea>
                    </div>

                    <div class="form-group">
                        <label class="control-label">Теги</label>
                        <input type="text" class="form-control" name="postTag" value=<?= $tags; ?>>
                    </div>
